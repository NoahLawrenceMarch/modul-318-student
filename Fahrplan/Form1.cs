...
namespace Fahrplan
{
    public partial class Form1 : Form
    {
        ...
        private void Get_Grid()
        {
            ...
            // Resulatat zur Liste hinzufügen
        ...
        private string Get_Time(string time1) //Zeit 
        {
        ...
        private void BTN_suche_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Abfahrt und Zielort eingeben!");
            }
        }
        ...
        {
            if (TXT_email.Text == "")
                MessageBox.Show("Email adresse eingeben!!");
            else
            {
                try
                {
                    MailMessage mail = new MailMessage();
                    mail.From = new MailAddress("Noah_lawrence@hotmail.com"); //Absender
                    mail.To.Add(new MailAddress(Convert.ToString(this.TXT_email))); //Empfänger
                    mail.Subject = "Fahrplan";
                    mail.Body = "Bester Fahrplan bratte. ";
                    mail.Body += "<b>" + Get_TableFromDataGrid() + "</b>";
                    mail.IsBodyHtml = true;
                    SmtpClient SmtpServer = new SmtpClient();//SMTP Server
                    SmtpServer.Host = "smtp.live.com";
                    SmtpServer.Port = 587;
                    SmtpServer.Credentials = new System.Net.NetworkCredential("Noah_lawrence@hotmail.com", "Supremeape");//Anmeldedaten für den SMTP Server
        ...
        private void LBX_von_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void LBX_nach_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void GRP_result_Enter(object sender, EventArgs e)
        {

        }

        private void GRP_suche_Enter(object sender, EventArgs e)
        {
        ...
        private void bkbutton2_Click(object sender, EventArgs e)
        {
            PNL_1.Visible = true;
            PNL_2.Visible = false;
            PNL_3.Visible = false;
